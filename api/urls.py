...
from .views import CreateUserView, ClienteViewSet, ServicoViewSet, AgendaOrdemListView, OrdemDeServicoViewSet, MaterialViewSet, MaterialUtilizadoViewSet, PagamentoViewSet, RegisterView, DashboardStatsView
