...
import { Box, Grid, Select, MenuItem, InputLabel, FormControl, Button, TextField, Typography } from '@mui/material';
          ...
          <FormControl fullWidth size="small">
            ...
            >
              ...
              {materiais.map(material => (
                <MenuItem key={material.id} value={material.id}>{material.nome}</MenuItem>
              ))}
            </Select>
          </FormControl>
        </Grid>
